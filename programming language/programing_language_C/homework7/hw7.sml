...
(* CHANGE: Add a case for Shift expressions *)
	  | Shift(deltaX, deltaY, e) =>
	  	(case (eval_prog(e, env)) of
		    NoPoints => NoPoints         (*TODO 犯了个傻的错误 以前写的是e*)
		  ...
		  | _ => raise Impossible "something wrong")
...
fun preprocess_prog (e) =
	case e of
      ...
      | LineSegment(x1,y1,x2,y2) =>
			...
			else if x2 < x1 - epsilon orelse (real_close(x1, x2) andalso y2 < y1)  (*TIP x2 < x1 如果float接近可能会出问题, 所以x2 < x1 - epsilon *)
